...
@section('title', 'Edit Service - VIS GmbH')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($service->icon)
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ asset('assets/img/services/' . $service->icon) }}" alt="Current Icon" class="img-thumbnail" style="max-width: 150px; max-height: 150px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($service->image)
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ asset('assets/img/services/' . $service->image) }}" alt="Current Image" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
